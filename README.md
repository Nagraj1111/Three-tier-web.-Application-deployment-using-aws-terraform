# # Three Tier Web Architecture Cloud Deployment using React Js NodeJS MongoDB AWS EKS Jenkins Git Terraform Kubernetes Prometheus Grafana ARGO CD Helm Charts AWS Load Balancers Prometheus Sonarqube Docker Trivy
